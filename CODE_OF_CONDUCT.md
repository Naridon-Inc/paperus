...
sexual identity and orientation. As contributors and maintainers, we pledge to
act and interact in ways that make this community open, welcoming, diverse, and
healthy.
...
- Taking responsibility, apologizing to those affected by our mistakes, and
  learning from them
- Focusing on what's best for the overall community, not just ourselves
...
and will take fair, appropriate corrective action in response to behavior they
deem inappropriate, threatening, offensive, or harmful. Maintainers may remove,
edit, or reject comments, commits, code, issues, and other contributions that are
not aligned with this Code of Conduct, and will communicate reasons when
appropriate.
...
[GitHub's report-abuse flow](https://docs.github.com/en/communities/maintaining-your-safety-on-github/reporting-abuse-or-spam)
or by opening a private security advisory on the repository (see
[SECURITY.md](SECURITY.md) for how to reach the maintainers privately). All
reports will be reviewed and investigated promptly and fairly. Maintainers are
obligated to respect the privacy and safety of anyone who reports an incident.
...
1. **Correction** — a private, written warning for unprofessional or unwelcome
   behavior, with clarity about why it was inappropriate. A public apology may be
   requested.
